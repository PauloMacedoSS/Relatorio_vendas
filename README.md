This project aims to automate the sending of a sales report from several stores, collecting the main information from an excel spreadsheet and sending the report by email.
